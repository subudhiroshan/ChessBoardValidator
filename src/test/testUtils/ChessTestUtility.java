...
public class ChessTestUtility {
    ...
    public static PieceLocation[][] getInitialChessBoardState(boolean blackon00) {
        ...
        if (blackon00) {
            ...
            initialChessBoard[6] = placeAllSoldiersInOneRow(1, TeamColor.WHITE);
            initialChessBoard[7] = placeNonSoldiersInOneRow(7, TeamColor.WHITE, true);
        } else {
            initialChessBoard[0] = placeNonSoldiersInOneRow(0, TeamColor.WHITE, blackon00);
            initialChessBoard[1] = placeAllSoldiersInOneRow(1, TeamColor.WHITE);
            initialChessBoard[6] = placeAllSoldiersInOneRow(1, TeamColor.BLACK);
            initialChessBoard[7] = placeNonSoldiersInOneRow(7, TeamColor.BLACK, blackon00);
        }
        ...
        for (int i=0; i<8; i++) {
            ...
            switch ((int) floor(abs(3.5-i))) {
                ...
                case 0 :
                    ...
                    nonSoldierSpotKing.setLocation(iAmHere);
                    PieceLocation nonSoldierSpotQueen = new PieceLocation();
                    nonSoldierSpotQueen.setLocation(iAmHere);
